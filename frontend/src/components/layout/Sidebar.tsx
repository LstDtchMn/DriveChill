...
import { LayoutDashboard, Activity, Bell, Settings, Snowflake, BarChart2, HardDrive, Thermometer, Moon } from 'lucide-react';
...
const NAV_ITEMS: { page: Page; label: string; icon: typeof LayoutDashboard }[] = [
  ...
  { page: 'quiet-hours', label: 'Quiet Hours', icon: Moon },
